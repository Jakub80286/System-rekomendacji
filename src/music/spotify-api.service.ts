...
export class SpotifyService {
  ...
  async getAudioInfo(trackId: string): Promise<AxiosResponse<any>> {
    ...
    try {
      const responseAudio =  await firstValueFrom(
       this.httpService
        .get(audioUrl, {
          headers: {
            Authorization: `Bearer ${this.accessToken}`,
      ...
      const responseTrack =  await firstValueFrom(
       this.httpService
        .get(trackUrl, {
          headers: {
            Authorization: `Bearer ${this.accessToken}`,
      ...
      for (const artist of artists) {
        ...
        if (!existingArtist) {
          ...
          const artistInfoResponse =  await firstValueFrom(
           this.httpService
            .get(artistInfoUrl, {
              headers: {
                Authorization: `Bearer ${this.accessToken}`,
      ...
      console.error(
        'Błąd podczas pobierania informacji o utworze:',
