    ...
    getPhotos(userId: number){
        ...
        async editPhoto(userId: number, photoId: number, editPhotoDto: EditPhotoDto) {
          ...
          const updatedPhoto = await this.prisma.photo.update({
              ...
              data: {
                  title: editPhotoDto.title !== undefined ? editPhotoDto.title : existingPhoto.title,
                  description: editPhotoDto.description !== undefined ? editPhotoDto.description : existingPhoto.description,
                  url: editPhotoDto.url !== undefined ? editPhotoDto.url : existingPhoto.url,
              },
          });
        ...
        async addLike(userId: number, photoId: number) {
            ...
            const photoExists = await this.prisma.photo.findFirst({
                where: {
                    photo_id: photoId,
                },
            });
            ...
            const newLike = await this.prisma.userLike.create({
                data: {
                    user_id: userId,
                    photo_id: photoId,
                },
